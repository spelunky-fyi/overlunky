...
local proj_from = {ENT_TYPE.ITEM_BULLET, ENT_TYPE.ITEM_FREEZERAYSHOT, ENT_TYPE.ITEM_CLONEGUNSHOT, ENT_TYPE.ITEM_UFO_LASER_SHOT,
...
local proj_to = {ENT_TYPE.ITEM_ROCK, ENT_TYPE.ITEM_EGGPLANT, ENT_TYPE.ITEM_BULLET, ENT_TYPE.ITEM_UFO_LASER_SHOT,
      ENT_TYPE.ITEM_LAMASSU_LASER_SHOT, ENT_TYPE.ITEM_SORCERESS_DAGGER_SHOT, ENT_TYPE.ITEM_LASERTRAP_SHOT,
      ENT_TYPE.ITEM_FIREBALL, ENT_TYPE.ITEM_HUNDUN_FIREBALL, ENT_TYPE.ITEM_ACIDSPIT, ENT_TYPE.ITEM_INKSPIT,
      ENT_TYPE.ITEM_WOODEN_ARROW, ENT_TYPE.ITEM_WEBSHOT, ENT_TYPE.ITEM_NUGGET_SMALL, ENT_TYPE.ITEM_SKULL}
local done = {}
