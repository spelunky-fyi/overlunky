...
items = {ENT_TYPE.MONS_SNAKE, ENT_TYPE.MONS_SPIDER, ENT_TYPE.MONS_HANGSPIDER, ENT_TYPE.MONS_GIANTSPIDER,
         ...
         ENT_TYPE.MONS_GHOST, ENT_TYPE.MONS_GHOST_MEDIUM_SAD, ENT_TYPE.MONS_GHOST_MEDIUM_HAPPY,
         ENT_TYPE.MONS_GHOST_SMALL_ANGRY, ENT_TYPE.MONS_GHOST_SMALL_SAD, ENT_TYPE.MONS_GHOST_SMALL_SURPRISED,
         ...
         ENT_TYPE.MOUNT_ROCKDOG, ENT_TYPE.MOUNT_AXOLOTL, ENT_TYPE.MOUNT_QILIN}
