...
#### Params: `int uid, int entity_type, int mask`
#### Returns: `array<int>`
...
#### Params: `int image, float x1, float y1, float x2, float y2, float uvx1, float uvy1, float uvx2, float uvy2, int color, float angle, float px, float py`
