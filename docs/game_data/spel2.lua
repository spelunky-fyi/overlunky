...
DROP = {
  ...
  COBRA_ACIDSPIT = 179,
  COFFIN_SKULL = 152,
  COOKEDTURKEY_HEALTH = 197,
  COOKFIRE_CAVEMAN_1 = 189,
  COOKFIRE_CAVEMAN_2 = 190,
  COOKFIRE_TORCH = 150,
  CROCMAN_TELEPACK = 29,
  ...
  GHOSTJAR_DIAMOND = 31,
  GHOST_DIAMOND = 32,
  GIANTFOOD_HEALTH = 198,
  GIANTFROG_FROG = 112,
  GIANTFROG_TADPOLE = 113,
  GIANTSPIDER_PASTE = 33,
  GIANTSPIDER_WEBSHOT = 160,
  GIANTSPIDER_WEB_LEFT = 194,
  GIANTSPIDER_WEB_RIGHT = 195,
