...
> Search script examples for [add_money_hud](https://github.com/spelunky-fyi/overlunky/search?l=Lua&q=add_money_hud)

#### int add_money_hud(int amount, optional<int> display_time)
