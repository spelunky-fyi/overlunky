...
const char *enum_themes[] = {"DWELLING", "JUNGLE", "VOLCANA", "OLMEC", "TIDE_POOL", "TEMPLE", "ICE_CAVES", "NEO_BABYLON", "SUNKEN_CITY", "COSMIC_OCEAN", "CITY_OF_GOLD", "DUAT", "ABZU", "TIAMAT", "EGGPLANT_WORLD", "HUNDUN", "BASE_CAMP"};
...
void init_script()
{
    g_state = (struct StateMemory *)get_state_ptr();
    g_state_addr = reinterpret_cast<uintptr_t>(g_state);
>>>>>>> e7e9a9d4408c8b7d61ef4a0f891a02ae88a73c64
