...
{
    return get_entities_by({}, ENTITY_MASK::ANY, LAYER::BOTH);
}
inline std::vector<uint32_t> get_entities_by(ENT_TYPE entity_type, ENTITY_MASK mask, LAYER layer)
{
...
{
    return get_entities_by(std::move(entity_types), ENTITY_MASK::ANY, LAYER::BOTH);
}
inline std::vector<uint32_t> get_entities_by_type(ENT_TYPE entity_type)
{
    return get_entities_by(std::vector<ENT_TYPE>{entity_type}, ENTITY_MASK::ANY, LAYER::BOTH);
}
inline std::vector<uint32_t> get_entities_by_mask(ENTITY_MASK mask)
{
    return get_entities_by({}, mask, LAYER::BOTH);
}
inline std::vector<uint32_t> get_entities_by_layer(LAYER layer)
{
    return get_entities_by({}, ENTITY_MASK::ANY, layer);
}
...
inline std::vector<uint32_t> get_entities_at(ENT_TYPE entity_type, ENTITY_MASK mask, float x, float y, LAYER layer, float radius)
{
...
inline std::vector<uint32_t> get_entities_overlapping_hitbox(ENT_TYPE entity_type, ENTITY_MASK mask, AABB hitbox, LAYER layer)
{
    return get_entities_overlapping_hitbox(std::vector<ENT_TYPE>{entity_type}, mask, hitbox, layer);
}
inline std::vector<uint32_t> get_entities_overlapping(std::vector<ENT_TYPE> entity_types, ENTITY_MASK mask, float sx, float sy, float sx2, float sy2, LAYER layer)
{
    return get_entities_overlapping_hitbox(std::move(entity_types), mask, {sx, sy2, sx2, sy}, layer);
}
inline std::vector<uint32_t> get_entities_overlapping(ENT_TYPE entity_type, ENTITY_MASK mask, float sx, float sy, float sx2, float sy2, LAYER layer)
{
...
inline std::vector<uint32_t> get_entities_overlapping_by_pointer(ENT_TYPE entity_type, ENTITY_MASK mask, float sx, float sy, float sx2, float sy2, Layer* layer)
{
...
inline std::vector<uint32_t> entity_get_items_by(uint32_t uid, ENT_TYPE entity_type, ENTITY_MASK mask)
{
