...
get_script_id = function()
    ...
    lua["StateMemory"]["speedrun_character"] = &StateMemory::speedrun_character;
    lua["StateMemory"]["speedrun_activation_trigger"] = &StateMemory::speedrun_activation_trigger;
    lua["StateMemory"]["end_spaceship_character"] = &StateMemory::end_spaceship_character;
    lua["StateMemory"]["world2_coffin_spawned"] = &StateMemory::world2_coffin_spawned;
    lua["StateMemory"]["world4_coffin_spawned"] = &StateMemory::world4_coffin_spawned;
    lua["StateMemory"]["world6_coffin_spawned"] = &StateMemory::world6_coffin_spawned;
    lua["StateMemory"]["first_damage_cause"] = &StateMemory::first_damage_cause;
    lua["StateMemory"]["first_damage_world"] = &StateMemory::first_damage_world;
    lua["StateMemory"]["first_damage_level"] = &StateMemory::first_damage_level;
    lua["StateMemory"]["time_speedrun"] = &StateMemory::time_speedrun;
    lua["StateMemory"]["coffin_contents"] = &StateMemory::coffin_contents;
    lua["StateMemory"]["screen_change_counter"] = &StateMemory::screen_change_counter;
    lua["StateMemory"]["time_startup"] = &StateMemory::time_startup;
