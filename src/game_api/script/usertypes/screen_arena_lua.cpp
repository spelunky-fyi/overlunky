...
void register_usertypes(sol::state& lua)
{
    ...
    screenarenamenu_type["top_woodpanel_slidein_timer"] = &ScreenArenaMenu::top_woodpanel_slidein_timer;
    screenarenamenu_type["top_scroll_unfurl_timer"] = &ScreenArenaMenu::top_scroll_unfurl_timer;
    screenarenamenu_type["unknown13"] = &ScreenArenaMenu::unknown13;
    screenarenamenu_type["woodpanel_top"] = &ScreenArenaMenu::woodpanel_top;
    screenarenamenu_type["unknown15"] = &ScreenArenaMenu::unknown15;
    screenarenamenu_type["left_scroll_handle"] = &ScreenArenaMenu::left_scroll_handle;
    screenarenamenu_type["right_scroll_handle"] = &ScreenArenaMenu::right_scroll_handle;
    screenarenamenu_type["scroll_text_id"] = &ScreenArenaMenu::scroll_text_id;
    screenarenamenu_type["unknown17_text_id"] = &ScreenArenaMenu::unknown17_text_id;
    screenarenamenu_type["unknown18_text_id"] = &ScreenArenaMenu::unknown18_text_id;
    screenarenamenu_type["unknown19_text_id"] = &ScreenArenaMenu::unknown19_text_id;
    screenarenamenu_type["top_woodpanel_visible"] = &ScreenArenaMenu::top_woodpanel_visible;
    screenarenamenu_type["bottom_woodpanel_visible"] = &ScreenArenaMenu::bottom_woodpanel_visible;
    screenarenamenu_type["woodpanels_toggle"] = &ScreenArenaMenu::woodpanels_toggle;
    ...
    screenarenastagesselect_type["woodenpanel_top_slidein_timer"] = &ScreenArenaStagesSelect::woodenpanel_top_slidein_timer;
    screenarenastagesselect_type["woodenpanel_top_scroll_unfurl_timer"] = &ScreenArenaStagesSelect::woodenpanel_top_scroll_unfurl_timer;
    screenarenastagesselect_type["woodenpanel_top"] = &ScreenArenaStagesSelect::woodenpanel_top;
    screenarenastagesselect_type["woodenpanel_top_left_scroll"] = &ScreenArenaStagesSelect::woodenpanel_top_left_scroll;
    screenarenastagesselect_type["woodenpanel_top_right_scroll"] = &ScreenArenaStagesSelect::woodenpanel_top_right_scroll;
    screenarenastagesselect_type["text_id_1"] = &ScreenArenaStagesSelect::text_id_1;
    screenarenastagesselect_type["text_id_2"] = &ScreenArenaStagesSelect::text_id_2;
    screenarenastagesselect_type["text_id_3"] = &ScreenArenaStagesSelect::text_id_3;
    screenarenastagesselect_type["text_id_4"] = &ScreenArenaStagesSelect::text_id_4;
    screenarenastagesselect_type["woodenpanel_top_visible"] = &ScreenArenaStagesSelect::woodenpanel_top_visible;
    screenarenastagesselect_type["woodenpanel_bottom_visible"] = &ScreenArenaStagesSelect::woodenpanel_bottom_visible;
    screenarenastagesselect_type["woodenpanels_toggle"] = &ScreenArenaStagesSelect::woodenpanels_toggle;
    ...
    screenarenaitems_type["woodpanel_top_scroll_unfurl_timer"] = &ScreenArenaItems::woodpanel_top_scroll_unfurl_timer;
    screenarenaitems_type["unknown9"] = &ScreenArenaItems::unknown9;
    screenarenaitems_type["woodpanel_top"] = &ScreenArenaItems::woodpanel_top;
    screenarenaitems_type["unknown11"] = &ScreenArenaItems::unknown11;
    screenarenaitems_type["top_scroll_left_handle"] = &ScreenArenaItems::top_scroll_left_handle;
    screenarenaitems_type["top_scroll_right_handle"] = &ScreenArenaItems::top_scroll_right_handle;
    screenarenaitems_type["scroll_text_id"] = &ScreenArenaItems::scroll_text_id;
    screenarenaitems_type["text_id_2"] = &ScreenArenaItems::text_id_2;
    screenarenaitems_type["text_id_3"] = &ScreenArenaItems::text_id_3;
    screenarenaitems_type["text_id_4"] = &ScreenArenaItems::text_id_4;
    screenarenaitems_type["woodpanel_top_visible"] = &ScreenArenaItems::woodpanel_top_visible;
    screenarenaitems_type["woodpanel_bottom_visible"] = &ScreenArenaItems::woodpanel_bottom_visible;
    screenarenaitems_type["woodpanels_toggle"] = &ScreenArenaItems::woodpanels_toggle;
