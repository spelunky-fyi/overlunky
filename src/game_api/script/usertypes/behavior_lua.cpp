...
void register_usertypes(sol::state& lua)
{
    ...
    lua["get_behavior_state_id"] = [](MovableBehavior* behavior) -> uint8_t
    {
    ...
    lua["set_custom_behavior_force_state"] = [](CustomMovableBehavior* behavior, sol::function force_state) -> void
    {
        LuaBackend* backend = LuaBackend::get_calling_backend();
    ...
    lua["set_custom_behavior_on_enter"] = [](CustomMovableBehavior* behavior, sol::function on_enter) -> void
    {
        LuaBackend* backend = LuaBackend::get_calling_backend();
    ...
    lua["set_custom_behavior_on_exit"] = [](CustomMovableBehavior* behavior, sol::function on_exit) -> void
    {
        LuaBackend* backend = LuaBackend::get_calling_backend();
    ...
    lua["set_custom_behavior_update_render"] = [](CustomMovableBehavior* behavior, sol::function update_render) -> void
    {
        LuaBackend* backend = LuaBackend::get_calling_backend();
    ...
    lua["set_custom_behavior_update_physics"] = [](CustomMovableBehavior* behavior, sol::function update_physics) -> void
    {
        LuaBackend* backend = LuaBackend::get_calling_backend();
    ...
    lua["set_custom_behavior_get_next_state_id"] = [](CustomMovableBehavior* behavior, sol::function get_next_state_id) -> void
    {
        LuaBackend* backend = LuaBackend::get_calling_backend();
    ...
    lua["get_base_behavior"] = get_base_behavior;
    lua["add_behavior"] = add_behavior;
    lua["clear_behavior"] = clear_behavior;
    lua["clear_behaviors"] = clear_behaviors;
    ...
    lua["update_movable"] = update_movable;
