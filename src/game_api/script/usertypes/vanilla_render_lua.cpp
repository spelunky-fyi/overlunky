...
void register_usertypes(sol::state& lua)
{
    auto draw_screen_texture = sol::overload(
        static_cast<void (VanillaRenderContext::*)(uint32_t, uint8_t, uint8_t, float, float, float, float, Color)>(&VanillaRenderContext::draw_screen_texture),
        static_cast<void (VanillaRenderContext::*)(uint32_t, uint8_t, uint8_t, const AABB&, Color)>(&VanillaRenderContext::draw_screen_texture));
    auto draw_world_texture = sol::overload(
        static_cast<void (VanillaRenderContext::*)(uint32_t, uint8_t, uint8_t, float, float, float, float, Color)>(&VanillaRenderContext::draw_world_texture),
        static_cast<void (VanillaRenderContext::*)(uint32_t, uint8_t, uint8_t, const AABB&, Color)>(&VanillaRenderContext::draw_world_texture));
