    ...
    entity_down_cast_map =
        {
            ...
            {"FxAnkhBrokenPiece", "as_entity"},
            {"FxAnkhRotatingSpark", "as_entity"},
            {"Birdies", "as_entity"},
            {"Button", "as_entity"},
            {"FxCompass", "as_entity"},
            {"FxFireflyLight", "as_entity"},
            {"MovingIcon", "as_entity"},
            {"FxEmpress", "as_entity"},
            {"Explosion", "as_entity"},
            {"FxHundunNeckPiece", "as_entity"},
            {"FxJetpackFlame", "as_entity"},
            {"FxKinguSliding", "as_entity"},
            {"FxLamassuAttack", "as_entity"},
            {"LiquidSurface", "as_entity"},
            {"FxMainExitDoor", "as_entity"},
            {"FxJellyfishStar", "as_entity"},
            {"MiniGameShipOffset", "as_entity"},
            {"FxNecromancerANKH", "as_entity"},
            {"OlmecFloater", "as_movable"},
            {"FxOuroboroDragonPart", "as_entity"},
            {"FxOuroboroOccluder", "as_entity"},
            {"FxPickupEffect", "as_entity"},
            {"FxPlayerIndicator", "as_entity"},
            {"FxQuickSand", "as_entity"},
            {"FxSaleContainer", "as_entity"},
            {"FxShotgunBlast", "as_entity"},
            {"SleepBubble", "as_entity"},
            {"Flame", "as_movable"},
            {"FxSorceressAttack", "as_entity"},
            {"FxSparkSmall", "as_entity"},
            {"FxSpringtrapRing", "as_entity"},
            {"LightEmitter", "as_movable"},
            {"FxTiamatHead", "as_entity"},
            {"FxTiamatTail", "as_entity"},
            {"FxTiamatTorso", "as_entity"},
            {"FxTornJournalPage", "as_entity"},
            {"FxUnderwaterBubble", "as_entity"},
            {"FxVatBubble", "as_entity"},
            {"FxWaterDrop", "as_entity"},
            {"FxWebbedEffect", "as_entity"},
            {"FxWitchdoctorHint", "as_entity"},
