...
enum SpawnType : SpawnTypeFlags
{
    ...
    SPAWN_TYPE_LEVEL_GEN_PROCEDURAL = 1 << 2,
    SPAWN_TYPE_LEVEL_GEN = SPAWN_TYPE_LEVEL_GEN_PROCEDURAL | SPAWN_TYPE_LEVEL_GEN_TILE_CODE,
    SPAWN_TYPE_SCRIPT = 1 << 2,
    SPAWN_TYPE_SYSTEMIC = 1 << 3,
...
int32_t spawn_entity_snap_to_floor(uint32_t id, float x, float y, int enum_layer);
int32_t spawn_entity_snap_to_grid(uint32_t entity_type, float x, float y, int enum_layer);
int32_t spawn_entity_abs_nonreplaceable(uint32_t entity_type, float x, float y, int enum_layer, float vx, float vy);
